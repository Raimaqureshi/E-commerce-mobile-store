  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Browse through a wide selection of latest and second-hand mobile phones at affordable prices."
        />
      </Head>
      <main className="min-h-screen bg-gray-100 p-6">
        <section className="bg-[url('https://t3.ftcdn.net/jpg/06/94/28/90/360_F_694289007_cj0ETFKmIH6gLfE3RJC3dUkQtDeoDOXT.jpg')] bg-cover bg-center sm:bg-top md:bg-center lg:bg-cover text-white py-20 px-4 text-left rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-600 mt-2">
                  The perfect choice for anyone looking for reliability and
                  style.
                </p>
              </div>
            </div>
       ...
       <section className="mt-12 bg-[url('https://global.hisense.com/dam/jcr:983144b1-36db-44ba-af97-7c15d37daa71/product-overview-hisense-smartphone-kv.h60-5g.jpg')] bg-cover bg-center sm:bg-top md:bg-center lg:bg-cover py-12 px-4 rounded-lg">
